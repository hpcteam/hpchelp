...
#!/bin/bash #PBS -N interFoam_32 #PBS -q workq #PBS -l
select=1:ncpus=32:mpiprocs=32:mem=192gb #PBS -l walltime=144:00:00 #PBS
-j oe #PBS -o openfoam.out #PBS -e openfoam.err
...
echo "===== ENV CHECK =====" which mpirun which icoFoam ldd \$(which
mpirun) \| grep ucx ldd \$(which icoFoam) \| grep mpi echo
"====================="
